...
- **免账号同步码**，在设备端加密个人进度
- **双区块离线词典与点词查询**，GRE 释义和 ECDICT 全部义项同时显示
...
- 英文释义、例句与词汇关系中的英文可以点击查询；GRE 主词即使命中已审核词库，也会同时显示 ECDICT 的全部离线译义。
- 内置精简 ECDICT 英汉词典共 11,414 个目标词条、37,343 个离线义项；每个展示义项至少有一条例句或明确标注的释义语境提示。
- 离线例句优先使用与词形、词性和释义精确匹配的 WordNet 3.0 语料；没有可靠语料句时不会伪造出处，而会标为“释义语境（非语料例句）”。
...
- 1,410 个机经 7.0 重点词
- 203 条已人工复核记录
- 11,414 个离线词典目标词条、37,343 个义项、42,228 条例句或释义语境提示
- SQLite 完整性检查：`ok`
...
离线义项中的语料例句使用 Princeton WordNet 3.0；仅保留包含当前词或其已记录词形、且与词性和英文释义精确匹配的例句。WordNet 许可与免责声明位于 `resources/WORDNET-LICENSE.txt`，网页版也公开提供两份词典许可文件。
