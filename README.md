...
- **四种学习模式**：阅读、简义、回忆、四选一
- **131 句 GRE 长难句**：一页一句、逐词点查、保留原书编号
...
- 句中每个英文单词都可以点击。查询窗口会优先显示离线中文总览、逐义项中文、WordNet 英文义项、例句和已收录词组；少量未被离线词典收录的专名、所有格或复合词仍会打开查询窗口，可主动使用联网翻译。需要整句或词组翻译时，也可以选中文本后翻译。
...
- 12,350 个点词目标中内置 12,060 个词条和 33,291 个独立义项，其中 14,167 个义项带有 COW 精确对应中文。
- 离线例句优先使用与当前词形、词性和释义精确匹配的 WordNet 3.0 语料；当前包含 20,608 条语料例句。没有可靠语料句时不会伪造出处，17,674 条替代内容均明确标为“释义语境（非语料例句）”。
...
- 1,410 个机经 7.0 重点词
- 203 条已人工复核记录
- 12,350 个点词目标中的 12,060 个离线词典词条（另有 290 个目标未收录），以及 24,384 条常用词组
- 33,291 个独立义项，其中 14,167 个义项带有 Chinese Open Wordnet 0.9 精确对应中文
- 20,608 条 WordNet 3.0 语料例句，以及 17,674 条明确标注的释义语境提示
- SQLite 完整性检查：`ok`
