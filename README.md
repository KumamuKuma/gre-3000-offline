...
- 11,633 个点词目标中内置 11,414 个词条和 31,551 个独立义项，其中 13,422 个义项带有 COW 精确对应中文。
- 离线例句优先使用与当前词形、词性和释义精确匹配的 WordNet 3.0 语料；当前包含 19,812 条语料例句。没有可靠语料句时不会伪造出处，16,570 条替代内容均明确标为“释义语境（非语料例句）”。
...
- 1,410 个机经 7.0 重点词
- 203 条已人工复核记录
- 11,633 个点词目标中的 11,414 个离线词典词条（另有 219 个目标未收录），以及 23,242 条常用词组
- 31,551 个独立义项，其中 13,422 个义项带有 Chinese Open Wordnet 0.9 精确对应中文
- 19,812 条 WordNet 3.0 语料例句，以及 16,570 条明确标注的释义语境提示
- SQLite 完整性检查：`ok`
